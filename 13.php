...
<?php 
    ...
    $covid = json_decode($url);
        ...
        $province = $covid[13]->province;
        $new_case = $covid[13]->new_case;
        $total_case = $covid[13]->total_case;
        $new_death = $covid[13]->new_death;
        $total_death = $covid[13]->total_death;
        $update_date = $covid[13]->update_date;
        ...
        print("<h2 class='text-white'>ยอดติดเชื้อในจังหวัด {$covid[13]->province}</h2>");
        print("<div class='card-body'>");
        print("<h4 class='text-white'>อัพเดทข้อมูลล่าสุด : {$covid[13]->update_date}</h4>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        ...
        print("<div class='card-body'>");
        print("<h4 class='text-white'>{$covid[13]->total_case} ราย</h4>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        ...
        print("<div class='card-body'>");
        print("<h6 class='text-white'>(เพิ่มขึ้น +{$covid[13]->new_case} ราย)</h6>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        ...
        print("<div class='card-body'>");
        print("<h4 class='text-white'>{$covid[13]->total_death} ราย</h4>");
        print("<h6 class='text-white'>(เพิ่มขึ้น +{$covid[13]->new_death} ราย)</h6>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
        print ("</div>");
